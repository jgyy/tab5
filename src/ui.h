...
// partial-redraw flicker. The panel is a MapleStory-styled gold/bronze window frame around four
// individually bordered, glossy, icon-labeled mini-bars sharing one row, left to right: player
